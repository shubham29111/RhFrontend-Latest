...
const staticFilters:FilterGroup[] = [
    ...
    },
    {
      ...
      technologies: [
        ...
        { name: "Maestro", id: "maestro-checkbox", count: '' },
        { name: "American Express", id: "american_express-checkbox", count: '' },
        { name: "JCB", id: "jcb-checkbox", count: '' },
    ...
    },
    {
      ...
      technologies: [
        ...
        { name: "Dining Area", id: "dining_area-checkbox", count: '' },
        { name: "Private Entrance", id: "private_entrance-checkbox", count: '' },
        { name: "Bedsheets", id: "bedsheets-checkbox", count: '' },
        { name: "Private Bathroom", id: "private_bathroom-checkbox", count: '' },
        { name: "Towels", id: "towels-checkbox", count: '' },
        { name: "External Private Bathroom", id: "external_private_bathroom-checkbox", count: '' },
        { name: "Safe", id: "safe-checkbox", count: '' },
        { name: "Wardrobe", id: "wardrobe-checkbox", count: '' },
        { name: "With View", id: "with_view-checkbox", count: '' },
        ...
        { name: "Bridal", id: "bridal-checkbox", count: '' },
        { name: "Mirror", id: "mirror-checkbox", count: '' },
        { name: "Shared Bathroom", id: "shared_bathroom-checkbox", count: '' },
        { name: "Soundproofing", id: "soundproofing-checkbox", count: '' },
        { name: "Balcony", id: "balcony-checkbox", count: '' },
        { name: "Hypoallergenic", id: "hypoallergenic-checkbox", count: '' },
        { name: "Tea or Coffee", id: "tea_or_coffee-checkbox", count: '' },
        { name: "Blackout Blinds", id: "blackout_blinds-checkbox", count: '' },
        { name: "Air Conditioning", id: "air_conditioning-checkbox", count: '' },
        { name: "Heating", id: "heating-checkbox", count: '' },
        { name: "Bath", id: "bath-checkbox", count: '' },
        { name: "TV", id: "tv-checkbox", count: '' },
